...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Handyman Tools Rental Contract</title>
		...
		<div id="main_container">
			...
			<div class="rentalContract">
				...
				<form action="RentalContract.php" method="post">
					<label class="title"><b><i>HANDYMAN TOOLS RENTAL CONTRACT</i></b></label> <br><br>
					...
					<label class="row6"><b>Estimated Rental : <b><?php print $estimatedRental ?></label> <br><br>

					<label class="row7"><b>Signature : <b> ________________________________________</label> <br><br>
