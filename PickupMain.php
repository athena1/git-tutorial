...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Handyman Tools Pick Up</title>
		...
		<div id="main_container">
			...
			<div class="center_content">
				...
				<div class="text_box">
					...
					<form action="PickupMain.php" method="post">

						<h1 style="color:#cc6600"> Handyman Tools Pick Up </h1>

						<div class="pickup_form_row">

							<label class="pickup_label">Reservation ID:</label>

							<input type="text" name="reservationId" class="pickup_input" />
